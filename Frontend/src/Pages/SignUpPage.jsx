...
const SignUpPage = () => {
  ...
  // this function is to validate the formdata, if the fullname is required than we can show the error fullname is required
  const validateForm = () => {
        ...
        <div className="w-full max-w-md space-y-8">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`z-0 input input-bordered w-full pl-10`}
                  placeholder="••••••••"
                ...
                >
                  {showPassword ? (
                    <EyeOff className="size-5 text-base-content/40 z-1" />
                  ) : (
                    <Eye className="size-5 text-base-content/40 z-1" />
                  )}
                </button>
              </div>
            </div>
          ...
          <div className="text-center flex justify-center space-x-2">
            ...
            <Link to="/login" className="link link-primary">
              <p className="text-primary z-10">Login</p>
            </Link>
          </div>
        </div>
      </div>
